...
namespace CardCells.utility
{
	public class ObjFact
	{
		...
		public void example()
		{
			// string myname=TesterNS.TestClassOne.whatsMyName();
			string fqan =
				"method=\"RunMe\" type=\"TesterNS.TestClassOne\" assembly=\"Tester2, Version=0.0.0.1, Culture=neutral, PublicKeyToken=null\"";

			Dictionary<string, string> did = splitValues(fqan);

			object x = ObjFact.getObjectfromString(did["assembly"], did["type"]);
			object rtrn = ObjFact.fireMethod(x, did["method"]);
			int d = 44;
			//Scheduler.o
		}
		// ////////////////////////////////////////////////////////////////////////////
		                                         ...
		                                         string objectName)
		{
			...
			//
			Assembly ass;
			if (assName.ToLower().Contains(".dll"))
				ass = Assembly.LoadFrom(assName);
			else
